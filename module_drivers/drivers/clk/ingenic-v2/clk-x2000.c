...
static struct ingenic_gate_clock x2000_gate_clks[] __initdata = {
    ...
    GATE(CLK_GATE_UART9, "gate_uart9", "div_apb", CPM_CLKGR1, 22, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART8, "gate_uart8", "div_apb", CPM_CLKGR1, 21, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART7, "gate_uart7", "div_apb", CPM_CLKGR1, 20, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART6, "gate_uart6", "div_apb", CPM_CLKGR1, 19, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART5, "gate_uart5", "div_apb", CPM_CLKGR1, 18, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART4, "gate_uart4", "div_apb", CPM_CLKGR1, 17, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
    GATE(CLK_GATE_UART3, "gate_uart3", "div_apb", CPM_CLKGR1, 16, CLK_IGNORE_UNUSED, CLK_GATE_SET_TO_DISABLE),
